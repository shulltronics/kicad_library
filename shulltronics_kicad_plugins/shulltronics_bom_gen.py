#
# Shulltronics BOM Generator
# By Carsten Thue-Bludworth, 2022
# 
# This script is a small adaptation of the built-in KiCad BOM Generator
#
...
"""
    ...
    Command line:
    python "pathToFile/bom_csv_grouped_by_value.py" "%I" "outputs/%O.csv"
"""
...
columns = ['Item', 'Reference(s)', 'Qty', 'Distributor', 'Dist. PN', 'Value'] + sorted(list(columnset))
print(columns)
...
### Shulltronics customization ###
row = []  # But keep this because we need it below
